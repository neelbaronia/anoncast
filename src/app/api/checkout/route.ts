...
// Use production keys if available, otherwise fallback to sandbox/test keys
const stripeSecretKey = process.env.STRIPE_SECRET_KEY || process.env.SANDBOX_STRIPE_SECRET_KEY;
